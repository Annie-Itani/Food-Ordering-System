...
<div>
                <div class="card-panel">
                  <div class="row">
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order" novalidate="novalidate">
                      <div class="row">
...
if(isset($_SESSION['user_id'])) {
    ...
    $sql = "SELECT cart.id as cart_id, items.id as item_id, items.name, items.price, cart.quantity 
            FROM cart 
...
<ul id="issues-collection" class="collection">
    ...
    foreach($cart_items as $item) {
        ...
        echo '<li class="collection-item">
                <div class="row">
                    <div class="col s7">
                        <p class="collections-title"><strong>#'.$item['item_id'].' </strong>'.$item['name'].'</p>
                    </div>
                    <div class="col s2">
