    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/user-router" novalidate="novalidate">
            <div class="row">
...
<table>
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/add-users" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
