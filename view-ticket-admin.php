...
<div class="section">
								...
								echo '<ul id="task-card" class="collection with-header">
									<div id="card-alert" class="card cyan">
										...
										<form method="post" action="routers/ticket-status">
                  ...
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/ticket-message" novalidate="novalidate" class="col s12">					  
                      <div class="row">
